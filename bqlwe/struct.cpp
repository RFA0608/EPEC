...
scalar_ft::scalar_ft()
{
    ...
    *(this->size + 1) = 1;
    ...
    mpf_init_set_str(*(this->scalar), "0.0", 10);
}
...
int64_t* scalar_64it::return_scalar()
{
    return this->scalar;
}
...
double* scalar_64ft::return_scalar()
{
    return this->scalar;
}
...
matrix_ft::matrix_ft(uint64_t row, uint64_t col)
{
    ...
    *(this->size + 1) = col;
    ...
    for(uint64_t i = 0; i < row; i++)
    {
        for(uint64_t j = 0; j < col; j++)
        {
            mpf_init_set_str(*(this->matrix + col * i + j), "0.0", 10);
        }
    }
}
...
int64_t* matrix_64it::return_matrix()
{
    return this->matrix;
}
...
double* matrix_64ft::return_matrix()
{
    return this->matrix;
}
...
mpz_t* polynomial_zt::return_polynomial()
{
...
mpf_t* polynomial_ft::return_polynomial()
{
    return this->polynomial;
}
...
int64_t* polynomial_64it::return_polynomial()
{
    return this->polynomial;
}
...
double* polynomial_64ft::return_polynomial()
{
    return this->polynomial;
}
